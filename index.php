...
if (isset($_GET['echostr'])) {
	...
	if (!empty($postStr)) {
		...
		$responseMessageObj = new responseMessageClass($reciveMessageObj->toUserName, $reciveMessageObj->fromUserName, $reciveMessageObj->createTime, $reciveMessageObj->msgType, $reciveMessageObj->resultContent);
